...
.mDiv_title{background-image: url(/s/i/poisk_bg.gif), url(//cdnbunny.org/i/poisk_bg.gif);background-size: 40% 100%;padding: 5px;border-bottom: 2px solid #ffea00; cursor: pointer;}
...
.mDiv_Popup > .mDiv_Popup_title {padding: 5px;font-size: 1.2em;font-family: cursive;border-radius: 6px 6px 0 0;background-image: url(/s/i/poisk_bg.gif), url(//cdnbunny.org/i/poisk_bg.gif);background-size: 40% 100%;color:white;}
...
(function() {
    ...
    const $ = window.jQuery,
          ...
          magnet_base64 = "data:image/png;base64,",
          download_base64 = "data:image/gif;base64,",
    ...
    function MakeFav(param){
        let elem = param.el || null,
            ...
            FavAddBlock = $('<div style="display: table-cell;vertical-align: middle;padding:5px; width: 10%; border-left: 1px dotted orange;">'+
                            '<div class="poleLinks"><a href="'+Down+'" target="_blank" title="Download"><img src="'+download_base64+'" alt="Download"></a></div>'+
                            '<div class="poleLinks"><a href="'+Mdown+'" target="_blank" title="Magnet Link"><img src="'+magnet_base64+'" alt="Magnet Link"></a></div>'+
